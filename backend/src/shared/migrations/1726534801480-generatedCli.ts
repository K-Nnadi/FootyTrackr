...
export class GeneratedCli1726534801480 implements MigrationInterface {
    name = 'GeneratedCli1726534801480'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."competition_type_enum" AS ENUM('League', 'Cup', 'Custom', 'Friendly')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."fixtureReferee_role_enum" AS ENUM('Main', 'Assistant', 'Var')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."lineUp_teamtype_enum" AS ENUM('Home', 'Away', 'Neutral')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."card_type_enum" AS ENUM('Yellow', 'Red')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."lineUp_teamtype_enum"`);
